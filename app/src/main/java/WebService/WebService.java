...
import com.example.semna9.LugaresTuristicosDeQuevedo;
...
public class WebService extends AsyncTask<String, Long, String> {
     ...
     */
    public  WebService(String urlWebService, Map<String, String> data, Context activity, LugaresTuristicosDeQuevedo callback) {
